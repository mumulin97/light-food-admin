...
const seedIngredients = [
  ['🥬', '嫩芽菠菜', 'VG-001', '蔬菜', 12.50, 'kg', 3.5, 10, '绿野农庄配送中心'],
  ['🍗', '精选鸡胸肉', 'MT-042', '肉类', 28.00, 'kg', 85.0, 20, '恒诚肉业'],
  ['🛢️', '一级大豆油', 'OIL-012', '粮油', 115.00, '桶', 12, 10, '清源粮油贸易'],
  ['🍯', '赤砂糖', 'COND-05', '调料', 4.50, 'kg', 45.0, 10, '原味食品有限公司'],
  ['🍵', '茉莉绿茶底', 'BEV-101', '饮品底料', 88.00, 'kg', 15.0, 5, '谷雨茶叶合作社'],
  ['🥑', '有机牛油果', 'VG-018', '蔬菜', 24.00, 'kg', 6.0, 8, '绿野农庄配送中心'],
  ['🐟', '冰鲜三文鱼', 'MT-051', '肉类', 96.00, 'kg', 30.0, 10, '鲜潮海产'],
  ['🍚', '有机藜麦', 'GR-007', '粮油', 36.00, 'kg', 22.0, 15, '清源粮油贸易'],
  ['🥛', '醇香燕麦奶', 'BEV-088', '饮品底料', 18.00, 'L', 40.0, 12, '晨曦有机牧场'],
  ['🧀', '低脂芝士', 'MT-063', '肉类', 52.00, 'kg', 9.0, 8, '晨曦有机牧场'],
  ['🥒', '脆感黄瓜', 'VG-025', '蔬菜', 6.80, 'kg', 55.0, 15, '绿野农庄配送中心'],
  ['🧂', '进口海盐', 'COND-11', '调料', 3.20, 'kg', 28.0, 5, '原味食品有限公司'],
  ['🫒', '特级橄榄油', 'OIL-020', '粮油', 168.00, '桶', 4, 6, '清源粮油贸易'],
  ['🍓', '冷冻草莓', 'VG-033', '蔬菜', 32.00, 'kg', 18.0, 10, '丰收果园贸易公司'],
  ['🍋', '黄柠檬', 'VG-041', '蔬菜', 9.50, 'kg', 7.0, 10, '丰收果园贸易公司'],
