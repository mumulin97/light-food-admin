...
import { formatOrderDateTime } from '../services/ordersApi'
...
const seedOrders = [
  ['#QS-4402', '张伟', 42.50, '制作中', '2023-10-24 12:45', '外带', [['抹茶能量碗', 1]]],
  ['#QS-4403', '王芳', 18.20, '待处理', '2023-10-24 12:52', '堂食', [['冷萃燕麦杯', 1]]],
  ['#QS-4398', '李明', 124.00, '待取餐', '2023-10-24 12:30', '外卖', [['轻盈双人套餐', 1], ['浆果排毒思慕雪', 2]]],
  ['#QS-4395', '赵敏', 56.75, '已完成', '2023-10-24 12:15', '堂食', [['牛油果高纤卷', 1], ['冷萃燕麦杯', 1]]],
  ['#QS-4390', '陈晨', 68.00, '待处理', '2023-10-24 12:08', '外带', [['藜麦田园沙拉', 2]]],
  ['#QS-4386', '刘洋', 34.00, '制作中', '2023-10-24 11:56', '堂食', [['藜麦田园沙拉', 1]]],
  ['#QS-4382', '孙丽', 90.50, '待取餐', '2023-10-24 11:47', '外卖', [['抹茶能量碗', 1], ['牛油果高纤卷', 1]]],
  ['#QS-4378', '周涛', 22.00, '已完成', '2023-10-24 11:39', '外带', [['冷萃燕麦杯', 1]]],
  ['#QS-4375', '吴静', 45.00, '待处理', '2023-10-24 11:30', '堂食', [['抹茶能量碗', 1]]],
  ['#QS-4371', '郑凯', 78.20, '制作中', '2023-10-24 11:22', '外卖', [['牛油果高纤卷', 1], ['藜麦田园沙拉', 1]]],
  ['#QS-4366', '冯婷', 15.50, '已取消', '2023-10-24 11:10', '堂食', [['浆果排毒思慕雪', 1]]],
  ['#QS-4362', '何强', 112.00, '待取餐', '2023-10-24 11:02', '外卖', [['轻盈双人套餐', 1], ['抹茶能量碗', 1]]],
  ['#QS-4358', '许娜', 36.00, '已完成', '2023-10-24 10:54', '外带', [['牛油果高纤卷', 1]]],
  ['#QS-4353', '邓超', 60.00, '待处理', '2023-10-24 10:45', '堂食', [['藜麦田园沙拉', 1], ['冷萃燕麦杯', 1]]],
  ['#QS-4349', '曾敏', 28.00, '制作中', '2023-10-24 10:37', '外带', [['冷萃燕麦杯', 1]]],
  ['#QS-4344', '彭勇', 84.50, '已完成', '2023-10-24 10:26', '外卖', [['抹茶能量碗', 1], ['牛油果高纤卷', 1]]],
  ['#QS-4340', '萧红', 42.50, '待取餐', '2023-10-24 10:18', '堂食', [['抹茶能量碗', 1]]],
  ['#QS-4335', '袁磊', 19.00, '已取消', '2023-10-24 10:05', '外带', [['浆果排毒思慕雪', 1]]],
...
function currentTimeLabel() {
  return formatOrderDateTime(new Date())
}
